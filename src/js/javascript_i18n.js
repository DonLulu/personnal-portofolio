function switchLanguage(lang) {
    ...
    const translations = {
        en: {
            ...
            geneva: "GENEVA",
            geneva_description: "I developed an educational video game for a Geneva speech therapy office over 3 months. The development was done in C# and was based on Unity for rendering. The game allowed children to work on their spelling by exploring a 2D environment.",
        ...
        fr: {
            ...
            gymrat: "Développement d'une application mobile de fitness en Flutter et Dart, elle permet de suivre les objectifs et performances de fitness. Les requêtes Chatgpt 4.0 permettent également la détection des nutriments en prenant une photo du plat pour le suivi des macros. La partie backend est intégrée en SQL et hébergée avec Firebase. Je prévois de le déployer sur App et Play store une fois terminé.",
